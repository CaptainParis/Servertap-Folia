package io.servertap.api.platform.bungee.routes;
...
/**
 * Route builder for BungeeCord
 */
public class BungeeRouteBuilder {

    private final String prefix;
    private final WebServer webServer;

    /**
     * Create a new BungeeRouteBuilder
     * @param prefix The route prefix
     * @param webServer The web server
     */
    public BungeeRouteBuilder(String prefix, WebServer webServer) {
        this.prefix = prefix;
